local minerblips = {
    {["CaveName"] = "Gold Mine", x = 2749.1728515625, y = 1320.4053955078, z = 68.944076538086, ["HasRares"] = true},
}
...
Citizen.CreateThread(function()
    while true do
        ...
        local pos = GetEntityCoords(ped)
        if InArea then
            local Rock = {x = 2749.1728515625, y = 1320.4053955078, z = 68.944076538086}
...
Citizen.CreateThread(function()
   local blip = N_0x554d9d53f696d002(1664425300,2806.6870117188, 1343.5390625, 70.410491943359)
